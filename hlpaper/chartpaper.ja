/* ═══════════════════════════════════════════════════════════════
   HLTrade Paper · chartpaper.js v4.0 — Final
   ✅ Centered Qty field
...
.c-nav-left { display:flex; align-items:center; gap:8px; }
  ...
  function startClock() {
    ...
    const tick = () => {
      ...
      const timeStr = now.toLocaleTimeString('en-US', { 
        ...
        minute: '2-digit', 
        second: '2-digit',
        timeZone: 'UTC' // Since we added the offset manually to Date.now()
      });
      ...
      if (d) d.textContent = `${dateStr} · UTC+3`;
    };
    tick();
